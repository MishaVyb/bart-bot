...
class UserModel(BaseModel):
    ...
    def __str__(self) -> str:
        try:
            return f'<UserModel({self.tg.username=})>'
        except:
            return super().__str__()


class StorageModel(BaseModel):
    participants: BackRef[list[UserModel]]
    requests: BackRef[list[UserModel]]
...
#     storage_request_id: Mapped[int | None] = mapped_column(ForeignKey('storage.id'), init=False, default=None)
#     storage_request: Mapped[StorageModel | None] = relationship(
#         foreign_keys=[storage_request_id],
#         lazy='joined',
...
#         foreign_keys=[UserModel.storage_id],
#         back_populates='storage',
#         #lazy='joined',
#         default_factory=list,
#         repr=False,
#     )
#     requests: Mapped[list[UserModel]] = relationship(
#         foreign_keys=[UserModel.storage_request_id],
#         back_populates='storage_request',
#         #lazy='joined',
#         default_factory=list,
#         repr=False,
#     )
